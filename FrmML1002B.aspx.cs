...
using ITG.Community;
using System.Data;
public partial class FrmML1002B : Itg.Community.PageBase
{
  string strQueryType = "";
  protected void Page_Load(object sender, EventArgs e)
  {
    ...
    if (GSTR_A_PRGID == "") GSTR_A_PRGID = "ML1002B";
    if (GSTR_U_PRGID == "") GSTR_U_PRGID = "ML1002B";
    //========================             
  ...
  private void rptCaseBind(string LSTR_Query)
  {
    try
    {
      ...
      {
        LSTR_QueryM = " AND CASESTATUS IN (''''1'''') ";
      }
      else
      {
