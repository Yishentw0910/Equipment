<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmML1002C.aspx.cs" Inherits="FrmML1002C" %>
          ...
          <ItemTemplate>
            <tr onmouseover="MouseOver(event)" onmouseout="MouseOut(event)" onclick="MouseDown(event);Row_Click(this)"
              ...
              <td width="27%"><%# Eval("CUSTNAME")%>
                ...
                <asp:TextBox CssClass="txt_QueryListForName" ReadOnly="true" style="display:none;" ID="lblCONTACTNAME"
