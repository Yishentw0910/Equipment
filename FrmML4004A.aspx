<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeFile="FrmML4004A.aspx.cs" Inherits="FrmML4004A" %>
           ...
           <div style="width:97%;border:1px solid #9FA1AD;margin-left:5px;margin-top:10px;">
              ...
              <table  cellpadding="1" cellspacing="1" class="tb_Info" id="tabCntrInfo">
                <tr>
                  ...
                  <td style="width:18%;text-align:center;"><B><asp:Label ID="spanINVStarus" style="display:;color:#FF0000;" runat="server" Text="已展期"></asp:Label></B><B><asp:Label ID="spanINVAPLY" style="display:none;color:#990099;" runat="server" Text="已開立"></asp:Label></B></td>
                </tr>
                <tr>
                  <th>客戶名稱</th>
                  <td colspan="5">
                    ...
                    <asp:TextBox ID="txtCUSTNAME" CssClass="txt_readonly" ReadOnly="true" Width="200px" runat="server"></asp:TextBox>
                   <%--20240316財務要求根據客戶性質判斷發票聯式--%>
                    <asp:TextBox ID="txtCUTYPE"  style="display:none;"  runat="server"></asp:TextBox></td>
                </tr>
                <tr>
                  <th>案件起租日</th>
            ...
            <div id="fraDispTypeInfo" class="H_600" style="width:98%;border:1px solid #9FA1AD;margin-left:5px;margin-top:10px;">
                   ...
                   <div style="width:97%;border:1px solid #9FA1AD;margin-left:5px;margin-top:10px;">
                      ...
                      <table  cellpadding="1" cellspacing="1" class="tb_Info" runat="server" id="tabCntrInvInfo">
                        <tr>
                          ...
                          <th width="15%">幾月一開</th>
                          <td width="15%"><asp:TextBox ID="txtPAYMONTHK" MaxLength="2" CssClass="txt_normal_right"  runat="server">1</asp:TextBox></td>
                        </tr>
                        <tr>
                          <th>單體彙開</th>
                          <td>
                            ...
                            </asp:DropDownList><input type="button" id="btnSplit" class="btn_normal" style="width:85px;padding:1px;display:;" runat="server" onclick="FrmML4003Click();" value="拆發票設定" />
                          </td>
                          <th>總體彙開</th>
                          <td colspan="3">
                   ...
                   <div style="width:97%;border:1px solid #9FA1AD;margin-left:5px;margin-top:10px;">
                       <div class="div_title">備註設定</div>
                        <table id="tabCntrInvRmkInfo"  cellpadding="1" cellspacing="1" class="tb_Info" runat="server">
                          <tr style="display:none;" runat="server">
                            ...
                            <td id="TD31" runat="server">
                              <asp:Button ID="btn11" CssClass="btn_normal" OnClientClick="return FrmML4004A_2Click('hdnSPECNOTE1');" runat="server" Text="特殊備註" />
                          ...
                          <tr style="display:none;" runat="server">
                            ...
                            <td id="TD9" runat="server">
                              <asp:Button ID="btn21" CssClass="btn_normal" OnClientClick="return FrmML4004A_2Click('hdnSPECNOTE2');"  runat="server" Text="特殊備註" />
                          ...
                          <tr style="display:none" runat="server">
                            ...
                            <td id="TD23" runat="server">
                              <asp:Button ID="btn31" CssClass="btn_normal" OnClientClick="return FrmML4004A_2Click('hdnSPECNOTE3');"  runat="server" Text="特殊備註" />
                          ...
                          <tr style="display:none;" runat="server">
                            ...
                            <td style="width: 121px" id="TD7" runat="server"><asp:CheckBox Checked="true" ID="chk45" Text="實體帳號" runat="server" />&nbsp;</td>
                              <td runat="server" id="TD37"><asp:CheckBox ID="chk46" style="display:none;" runat="server" Text="繳款日"/>&nbsp;</td>
                            <td id="TD18" runat="server">
                              <asp:Button ID="btn41" CssClass="btn_normal" OnClientClick="return FrmML4004A_2Click('hdnSPECNOTE4');"  runat="server" Text="特殊備註" />
                          ...
                          <tr style="display:none;" runat="server">
                            ...
                            <td id="TD20" runat="server">
                              <asp:Button ID="btn51" CssClass="btn_normal" OnClientClick="return FrmML4004A_2Click('hdnSPECNOTE5');"  runat="server" Text="特殊備註" />
                          ...
                          <tr style="display:none;" runat="server">
                            ...
                            <td id="TD17" runat="server">
                              <asp:Button ID="btn61" CssClass="btn_normal" OnClientClick="return FrmML4004A_2Click('hdnSPECNOTE6');"  runat="server" Text="特殊備註" />
                        ...
                        <div class="btn_div">
                          ...
                          <asp:Button ID="btnUA" runat="server" Text="整批重展" Enabled="false" CssClass="btn_normal" onclick="btnUA_Click"/>
                   ...
                   <div class="div_table" style="overflow:auto;margin-left:5px;margin-top:10px;height:375px;">
                      ...
                      <ItemTemplate>
		                  <tr  onmouseover="MouseOver(event)" onmouseout="MouseOut(event)" onclick="MouseDown(event);">
		                    ...
		                    <td><asp:Label ID="lblUNITID"  Text='<%# Eval("UNITID")%>' runat="server"></asp:Label></td>
		                    <td>
		                    ...
		                    <td><asp:Label ID="lblRENTYEARS"  Text='<%# Eval("RENTYEARS")%>' runat="server"></asp:Label></td>
		                    <td><asp:Label ID="lblPREINVYYYYMM"  Text='<%# Eval("PREINVYYYYMM")%>'  style="display:;" runat="server"></asp:Label><asp:TextBox ID="txtPREINVYYYYMM" onfocus="txtPREINVYYYYMM_onfocus(this);" onblur="txtPREINVYYYYMM_onblur(this);"  Text='<%# Eval("PREINVYYYYMM")%>' style="display:none;" CssClass="txt_table" runat="server"></asp:TextBox></td>
		                    <td>
                           <input type="button" id="btnINVDESC" class="btn_normal" onclick="return FrmML4004A_1Click(this, 'hdnINVDESC', 'hdnAMOUNT', 'hdnTAX', 'hdnPRINCIPAL', 'hdnINSTAMT', 'hdnISSUE');" value="品名設定" style="padding:2px;" />
		                    ...
		                    <td><asp:Label ID="lblINVDATE"  Text='<%# Eval("INVDATE")%>' runat="server"></asp:Label></td>
		                    <td><asp:Label ID="lblINVNO"  Text='<%# Eval("INVNO")%>' runat="server"></asp:Label></td>
		                    <td><asp:TextBox ID="txtTARGETID"   Text='<%# Eval("TARGETID")%>'  CssClass="txt_table" runat="server"></asp:TextBox></td>
		                    <td><asp:TextBox ID="txtTARGETNAME"  Text='<%# Eval("TARGETNAME")%>'   CssClass="txt_table" runat="server"></asp:TextBox></td>
		                    <td style="text-align:right;"><asp:Label ID="lblMONTHPAY"  Text='<%# System.Convert.ToDecimal(Eval("MONTHPAY").ToString()).ToString("#,##0")%>' runat="server"></asp:Label></td>
		                    <td>
		                     <asp:TextBox ID="txtINVZIPCODE"   Text='<%# Eval("INVZIPCODE")%>'  onkeyup="CheckNumber_keyup(this);" MaxLength="6" runat="server" Width="60px"  onblur="PostCodeBlure(this)"  CssClass="txt_table" ></asp:TextBox>
 		                     <asp:Button ID="btnINVZIPCODE" CssClass="btn_normal" OnClientClick="PostCodeClick(this);"   style="width:25px;padding:2px;"  runat="server" Text="&#8230;" />
                             <asp:TextBox ID="txtINVZIPCODES"   Text='<%# Eval("INVZIPCODES")%>'  runat="server" Width="120px" CssClass="txt_table"  onfocus="ObjMFocus(this,'txtINVZIPCODES','txtINVOICEADDR');"  ></asp:TextBox>
                             <asp:TextBox ID="txtINVOICEADDR"   Text='<%# Eval("INVOICEADDR")%>'  runat="server" CssClass="txt_table" Width="150px"  MaxLength="100"  onblur="CheckMLength(this,'100');"  ></asp:TextBox>             
		                    </td>
		                    <td><asp:TextBox ID="txtORDERDAY"   Text='<%# Eval("ORDERDAY")%>' CssClass="txt_table" runat="server"></asp:TextBox></td>
		                    <td>
		                    ...
		                    <asp:Button ID="btnBZ" CssClass="btn_normal" OnClientClick="return FrmML4004A_2Click2(this,'btnBZ','hdnBZ','tabInvoDtl');"   runat="server" Text="備註" />
                            <asp:HiddenField ID="hdnBZ"  Value='<%# Eval("BZ")%>' runat="server" />
		                    </td>
		                    <td><asp:Label ID="spanFGSPLIT"  Text='<%# Eval("FGSPLITNME")%>' runat="server"></asp:Label><asp:HiddenField ID="hdnFGSPLIT"  Value='<%# Eval("FGSPLIT")%>' runat="server" /></td>
		                    <td><asp:Label ID="spanFGSINGLE"  Text='<%# Eval("FGSINGLENME")%>' runat="server"></asp:Label><asp:HiddenField ID="hdnFGSINGLE"  Value='<%# Eval("FGSINGLE")%>' runat="server" /></td>
		                    <td><asp:Label ID="spanFGSUMMARY"  Text='<%# Eval("MTRCNTRNO")%>' runat="server"></asp:Label></td>
		                  </tr>
		                    </ItemTemplate>
		                    </asp:Repeater>
		                </table>
                         <input type="button" id="btnMdyPreMonth" class="btn_normal" style="width:85px;padding:1px;display:none;" onclick="btnMdyPreMonth_onClick(this);" value="修正預開發票年月" />
		              </div>
                </div>
                <%--本體分差發票End --%>
                <%--手續費發票Begin --%>
	                    ...
	                    <table id="tabCntrInvRmkInfo_2"  cellpadding="1" cellspacing="1" class="tb_Info" runat="server">
                          <tr runat="server">
                            ...
                            <td id="TD23_2" runat="server">
                              <asp:Button ID="btn31_2" CssClass="btn_normal" OnClientClick="return FrmML4004A_2Click('hdnSPECNOTE3_2');"  runat="server" Text="特殊備註" />
                              <asp:HiddenField ID="hdnSPECNOTE3_2" Value="" runat="server" />
                            </td>
                          </tr>
	                    </table>
                        <div class="btn_div">
                            <asp:Button ID="btnUA_2" runat="server" Text="整批重展" Enabled="false" CssClass="btn_normal" onclick="btnUA_2_Click"/>
                        </div>
                    </div>
                   <div class="div_table" style="overflow:auto;margin-left:5px;margin-top:10px;height:375px;">
                      ...
                      <ItemTemplate>
		                  <tr  onmouseover="MouseOver(event)" onmouseout="MouseOut(event)" onclick="MouseDown(event);">
		                    <td>
                                ...
                                <asp:HiddenField ID="hdnPREOPENWAY_2" Value="" runat="server" />
                                <asp:Label ID="lblISSUE_2"  Text='<%# System.Convert.ToDecimal(Eval("ISSUE")).ToString("#00")%>' runat="server"></asp:Label></td>
		                    <td><asp:Label ID="lblUNITID_2"  Text='<%# Eval("UNITID")%>' runat="server"></asp:Label></td>
		                    <td>
		                    ...
		                    <td><asp:Label ID="lblRENTYEARS_2"  Text='<%# Eval("RENTYEARS")%>' runat="server"></asp:Label></td>
		                    <td><asp:Label ID="lblPREINVYYYYMM_2"  Text='<%# Eval("PREINVYYYYMM")%>'  style="display:;" runat="server"></asp:Label><asp:TextBox ID="txtPREINVYYYYMM_2" onfocus="txtPREINVYYYYMM_onfocus(this);" onblur="txtPREINVYYYYMM_onblur(this);"  Text='<%# Eval("PREINVYYYYMM")%>' style="display:none;" CssClass="txt_table" runat="server"></asp:TextBox></td>
		                    <td>
                           <input type="button" id="btnINVDESC_2" class="btn_normal" onclick="return FrmML4004A_1Click(this, 'hdnINVDESC_2', 'hdnAMOUNT_2', 'hdnTAX_2', 'hdnPRINCIPAL_2', 'hdnINSTAMT_2', 'hdnISSUE_2');" value="品名設定" style="padding:2px;" />
                            ...
                            <asp:HiddenField ID="hdnINVDATE_2" Value='<%# Eval("INVDATE")%>' runat="server" />
                            <asp:HiddenField ID="hdnINVNO_2" Value='<%# Eval("INVNO")%>' runat="server" />
                            <asp:HiddenField ID="hdnISSUE_2"  Value='<%# System.Convert.ToDecimal(Eval("ISSUE")).ToString("#00") %>' runat="server" />
                        </td>
		                    <td>
		                      <asp:DropDownList ID="drpTAXTYPE_2" runat="server">
                                <asp:ListItem Value="1">應稅</asp:ListItem>
                                <asp:ListItem Value="2">零稅</asp:ListItem>
                                <asp:ListItem Value="3">免稅</asp:ListItem>
                              </asp:DropDownList>
		                    </td>
		                    <td><asp:Label ID="lblINVDATE_2"  Text='<%# Eval("INVDATE")%>' runat="server"></asp:Label></td>
		                    <td><asp:Label ID="lblINVNO_2"  Text='<%# Eval("INVNO")%>' runat="server"></asp:Label></td>
		                    <td><asp:TextBox ID="txtTARGETID_2"   Text='<%# Eval("TARGETID")%>'  CssClass="txt_table" runat="server"></asp:TextBox></td>
		                    <td><asp:TextBox ID="txtTARGETNAME_2"  Text='<%# Eval("TARGETNAME")%>'   CssClass="txt_table" runat="server"></asp:TextBox></td>
		                    <td style="text-align:right;"><asp:Label ID="lblMONTHPAY_2"  Text='<%# System.Convert.ToDecimal(Eval("MONTHPAY").ToString()).ToString("#,##0")%>' runat="server"></asp:Label></td>
		                    <td>
		                     <asp:TextBox ID="txtINVZIPCODE_2"   Text='<%# Eval("INVZIPCODE")%>'  onkeyup="CheckNumber_keyup(this);" MaxLength="6" runat="server" Width="60px"  onblur="PostCodeBlure(this)"  CssClass="txt_table" ></asp:TextBox>
 		                     <asp:Button ID="btnINVZIPCODE_2" CssClass="btn_normal" OnClientClick="PostCodeClick(this);"   style="width:25px;padding:2px;"  runat="server" Text="&#8230;" />
                             <asp:TextBox ID="txtINVZIPCODES_2"   Text='<%# Eval("INVZIPCODES")%>'  runat="server" Width="120px" CssClass="txt_table"  onfocus="ObjMFocus(this,'txtINVZIPCODES_2','txtINVOICEADDR_2');"  ></asp:TextBox>
                             <asp:TextBox ID="txtINVOICEADDR_2"   Text='<%# Eval("INVOICEADDR")%>'  runat="server" CssClass="txt_table" Width="150px"  MaxLength="100"  onblur="CheckMLength(this,'100');"  ></asp:TextBox>             
		                    </td>
		                    <td><asp:TextBox ID="txtORDERDAY_2"   Text='<%# Eval("ORDERDAY")%>' CssClass="txt_table" runat="server"></asp:TextBox></td>
		                    <td>
		                      <asp:DropDownList ID="drpINVKIND_2" runat="server">
                                <asp:ListItem Value="2">二聯式</asp:ListItem>
                                <asp:ListItem Value="3">三聯式</asp:ListItem>
                              </asp:DropDownList>
		                    </td>
		                    <td style="text-align:left">
		                    <asp:Button ID="btnBZ_2" CssClass="btn_normal" OnClientClick="return FrmML4004A_2Click2(this,'btnBZ_2','hdnBZ_2','tabInvoDtl_2');"   runat="server" Text="備註" />
                            <asp:HiddenField ID="hdnBZ_2"  Value='<%# Eval("BZ")%>' runat="server" />
		                    </td>
		                    <td><asp:Label ID="spanFGSPLIT_2"  Text='<%# Eval("FGSPLITNME")%>' runat="server"></asp:Label><asp:HiddenField ID="hdnFGSPLIT_2"  Value='<%# Eval("FGSPLIT")%>' runat="server" /></td>
		                    <td><asp:Label ID="spanFGSINGLE_2"  Text='<%# Eval("FGSINGLENME")%>' runat="server"></asp:Label><asp:HiddenField ID="hdnFGSINGLE_2"  Value='<%# Eval("FGSINGLE")%>' runat="server" /></td>
		                    <td><asp:Label ID="spanFGSUMMARY_2"  Text='<%# Eval("MTRCNTRNO")%>' runat="server"></asp:Label></td>
		                  </tr>
		                    </ItemTemplate>
		                    </asp:Repeater>
		                </table>                         
	                    ...
	                    <table id="tabCntrInvRmkInfo_3"  cellpadding="1" cellspacing="1" class="tb_Info" runat="server">
                          <tr runat="server">
                            ...
                            <td id="TD23_3" runat="server">
                              <asp:Button ID="btn31_3" CssClass="btn_normal" OnClientClick="return FrmML4004A_2Click('hdnSPECNOTE3_3');"  runat="server" Text="特殊備註" />
                              <asp:HiddenField ID="hdnSPECNOTE3_3" Value="" runat="server" />
                            </td>
                          </tr>	                    
                        </table>
                        <div class="btn_div">
                            <asp:Button ID="btnUA_3" runat="server" Text="整批重展" Enabled="false" CssClass="btn_normal" onclick="btnUA_3_Click"/>
                        </div>
                    </div>
                   <div class="div_table" style="overflow:auto;margin-left:5px;margin-top:10px;height:375px;">
                      ...
                      <ItemTemplate>
		                  <tr  onmouseover="MouseOver(event)" onmouseout="MouseOut(event)" onclick="MouseDown(event);">
		                    <td>
                                ...
                                <asp:HiddenField ID="hdnPREOPENWAY_3" Value="" runat="server" />
                                <asp:Label ID="lblISSUE_3"  Text='<%# System.Convert.ToDecimal(Eval("ISSUE")).ToString("#00")%>' runat="server"></asp:Label></td>
		                    <td><asp:Label ID="lblUNITID_3"  Text='<%# Eval("UNITID")%>' runat="server"></asp:Label></td>
		                    <td>
		                    ...
		                    <td><asp:Label ID="lblRENTYEARS_3"  Text='<%# Eval("RENTYEARS")%>' runat="server"></asp:Label></td>
		                    <td><asp:Label ID="lblPREINVYYYYMM_3"  Text='<%# Eval("PREINVYYYYMM")%>'  style="display:;" runat="server"></asp:Label><asp:TextBox ID="txtPREINVYYYYMM_3" onfocus="txtPREINVYYYYMM_onfocus(this);" onblur="txtPREINVYYYYMM_onblur(this);"  Text='<%# Eval("PREINVYYYYMM")%>' style="display:none;" CssClass="txt_table" runat="server"></asp:TextBox></td>
		                    <td>
                           <input type="button" id="btnINVDESC_3" class="btn_normal" onclick="return FrmML4004A_1Click(this, 'hdnINVDESC_3', 'hdnAMOUNT_3', 'hdnTAX_3', 'hdnPRINCIPAL_3', 'hdnINSTAMT_3', 'hdnISSUE_3');" value="品名設定" style="padding:2px;" />
                            ...
                            <asp:HiddenField ID="hdnINVDATE_3" Value='<%# Eval("INVDATE")%>' runat="server" />
                            <asp:HiddenField ID="hdnINVNO_3" Value='<%# Eval("INVNO")%>' runat="server" />
                            <asp:HiddenField ID="hdnISSUE_3"  Value='<%# System.Convert.ToDecimal(Eval("ISSUE")).ToString("#00") %>' runat="server" />
                        </td>
		                    <td>
		                      <asp:DropDownList ID="drpTAXTYPE_3" runat="server">
                                <asp:ListItem Value="1">應稅</asp:ListItem>
                                <asp:ListItem Value="2">零稅</asp:ListItem>
                                <asp:ListItem Value="3">免稅</asp:ListItem>
                              </asp:DropDownList>
		                    </td>
		                    <td><asp:Label ID="lblINVDATE_3"  Text='<%# Eval("INVDATE")%>' runat="server"></asp:Label></td>
		                    <td><asp:Label ID="lblINVNO_3"  Text='<%# Eval("INVNO")%>' runat="server"></asp:Label></td>
		                    <td><asp:TextBox ID="txtTARGETID_3"   Text='<%# Eval("TARGETID")%>'  CssClass="txt_table" runat="server"></asp:TextBox></td>
		                    <td><asp:TextBox ID="txtTARGETNAME_3"  Text='<%# Eval("TARGETNAME")%>'   CssClass="txt_table" runat="server"></asp:TextBox></td>
		                    <td style="text-align:right;"><asp:Label ID="lblMONTHPAY_3"  Text='<%# System.Convert.ToDecimal(Eval("MONTHPAY").ToString()).ToString("#,##0")%>' runat="server"></asp:Label></td>
		                    <td>
		                     <asp:TextBox ID="txtINVZIPCODE_3"   Text='<%# Eval("INVZIPCODE")%>'  onkeyup="CheckNumber_keyup(this);" MaxLength="6" runat="server" Width="60px"  onblur="PostCodeBlure(this)"  CssClass="txt_table" ></asp:TextBox>
 		                     <asp:Button ID="btnINVZIPCODE_3" CssClass="btn_normal" OnClientClick="PostCodeClick(this);"   style="width:25px;padding:2px;"  runat="server" Text="&#8230;" />
                             <asp:TextBox ID="txtINVZIPCODES_3"   Text='<%# Eval("INVZIPCODES")%>'  runat="server" Width="120px" CssClass="txt_table"  onfocus="ObjMFocus(this,'txtINVZIPCODES_3','txtINVOICEADDR_3');"  ></asp:TextBox>
                             <asp:TextBox ID="txtINVOICEADDR_3"   Text='<%# Eval("INVOICEADDR")%>'  runat="server" CssClass="txt_table" Width="150px"  MaxLength="100"  onblur="CheckMLength(this,'100');"  ></asp:TextBox>             
		                    </td>
		                    <td><asp:TextBox ID="txtORDERDAY_3"   Text='<%# Eval("ORDERDAY")%>' CssClass="txt_table" runat="server"></asp:TextBox></td>
		                    <td>
		                      <asp:DropDownList ID="drpINVKIND_3" runat="server">
                                <asp:ListItem Value="2">二聯式</asp:ListItem>
                                <asp:ListItem Value="3">三聯式</asp:ListItem>
                              </asp:DropDownList>
		                    </td>
		                    <td style="text-align:left">
		                    <asp:Button ID="btnBZ_3" CssClass="btn_normal" OnClientClick="return FrmML4004A_2Click2(this,'btnBZ_3','hdnBZ_3','tabInvoDtl_3');"   runat="server" Text="備註" />
                            <asp:HiddenField ID="hdnBZ_3"  Value='<%# Eval("BZ")%>' runat="server" />
		                    </td>
		                    <td><asp:Label ID="spanFGSPLIT_3"  Text='<%# Eval("FGSPLITNME")%>' runat="server"></asp:Label><asp:HiddenField ID="hdnFGSPLIT_3"  Value='<%# Eval("FGSPLIT")%>' runat="server" /></td>
		                    <td><asp:Label ID="spanFGSINGLE_3"  Text='<%# Eval("FGSINGLENME")%>' runat="server"></asp:Label><asp:HiddenField ID="hdnFGSINGLE_3"  Value='<%# Eval("FGSINGLE")%>' runat="server" /></td>
		                    <td><asp:Label ID="spanFGSUMMARY_3"  Text='<%# Eval("MTRCNTRNO")%>' runat="server"></asp:Label></td>
		                  </tr>
		                    </ItemTemplate>
		                    </asp:Repeater>
		                </table>                         
	                    ...
	                    <table id="tabCntrInvRmkInfo_4"  cellpadding="1" cellspacing="1" class="tb_Info" runat="server">
                          <tr runat="server">
                            ...
                            <td id="TD23_4" runat="server">
                              <asp:Button ID="btn31_4" CssClass="btn_normal" OnClientClick="return FrmML4004A_2Click('hdnSPECNOTE3_4');"  runat="server" Text="特殊備註" />
                              <asp:HiddenField ID="hdnSPECNOTE3_4" Value="" runat="server" />
                            </td>
                          </tr>
	                    </table>
                        <div class="btn_div">
                            <asp:Button ID="btnUA_4" runat="server" Text="整批重展" Enabled="false" CssClass="btn_normal" onclick="btnUA_4_Click"/>
                        </div>
                    </div>
                   <div class="div_table" style="overflow:auto;margin-left:5px;margin-top:10px;height:375px;">
                      ...
                      <ItemTemplate>
		                  <tr  onmouseover="MouseOver(event)" onmouseout="MouseOut(event)" onclick="MouseDown(event);">
		                    <td>
                                ...
                                <asp:HiddenField ID="hdnPREOPENWAY_4" Value="" runat="server" />
                                <asp:Label ID="lblISSUE_4"  Text='<%# System.Convert.ToDecimal(Eval("ISSUE")).ToString("#00")%>' runat="server"></asp:Label></td>
		                    <td><asp:Label ID="lblUNITID_4"  Text='<%# Eval("UNITID")%>' runat="server"></asp:Label></td>
		                    <td>
		                    ...
		                    <td><asp:Label ID="lblRENTYEARS_4"  Text='<%# Eval("RENTYEARS")%>' runat="server"></asp:Label></td>
		                    <td><asp:Label ID="lblPREINVYYYYMM_4"  Text='<%# Eval("PREINVYYYYMM")%>'  style="display:;" runat="server"></asp:Label><asp:TextBox ID="txtPREINVYYYYMM_4" onfocus="txtPREINVYYYYMM_onfocus(this);" onblur="txtPREINVYYYYMM_onblur(this);"  Text='<%# Eval("PREINVYYYYMM")%>' style="display:none;" CssClass="txt_table" runat="server"></asp:TextBox></td>
		                    <td>
                           <input type="button" id="btnINVDESC_4" class="btn_normal" onclick="return FrmML4004A_1Click(this, 'hdnINVDESC_4', 'hdnAMOUNT_4', 'hdnTAX_4', 'hdnPRINCIPAL_4', 'hdnINSTAMT_4', 'hdnISSUE_4');" value="品名設定" style="padding:2px;" />
                            ...
                            <asp:HiddenField ID="hdnINVDATE_4" Value='<%# Eval("INVDATE")%>' runat="server" />
                            <asp:HiddenField ID="hdnINVNO_4" Value='<%# Eval("INVNO")%>' runat="server" />
                            <asp:HiddenField ID="hdnISSUE_4"  Value='<%# System.Convert.ToDecimal(Eval("ISSUE")).ToString("#00") %>' runat="server" />
                        </td>
		                    <td>
		                      <asp:DropDownList ID="drpTAXTYPE_4" runat="server">
                                <asp:ListItem Value="1">應稅</asp:ListItem>
                                <asp:ListItem Value="2">零稅</asp:ListItem>
                                <asp:ListItem Value="3">免稅</asp:ListItem>
                              </asp:DropDownList>
		                    </td>
		                    <td><asp:Label ID="lblINVDATE_4"  Text='<%# Eval("INVDATE")%>' runat="server"></asp:Label></td>
		                    <td><asp:Label ID="lblINVNO_4"  Text='<%# Eval("INVNO")%>' runat="server"></asp:Label></td>
		                    <td><asp:TextBox ID="txtTARGETID_4"   Text='<%# Eval("TARGETID")%>'  CssClass="txt_table" runat="server"></asp:TextBox></td>
		                    <td><asp:TextBox ID="txtTARGETNAME_4"  Text='<%# Eval("TARGETNAME")%>'   CssClass="txt_table" runat="server"></asp:TextBox></td>
		                    <td style="text-align:right;"><asp:Label ID="lblMONTHPAY_4"  Text='<%# System.Convert.ToDecimal(Eval("MONTHPAY").ToString()).ToString("#,##0")%>' runat="server"></asp:Label></td>
		                    <td>
		                     <asp:TextBox ID="txtINVZIPCODE_4"   Text='<%# Eval("INVZIPCODE")%>'  onkeyup="CheckNumber_keyup(this);" MaxLength="6" runat="server" Width="60px"  onblur="PostCodeBlure(this)"  CssClass="txt_table" ></asp:TextBox>
 		                     <asp:Button ID="btnINVZIPCODE_4" CssClass="btn_normal" OnClientClick="PostCodeClick(this);"   style="width:25px;padding:2px;"  runat="server" Text="&#8230;" />
                             <asp:TextBox ID="txtINVZIPCODES_4"   Text='<%# Eval("INVZIPCODES")%>'  runat="server" Width="120px" CssClass="txt_table"  onfocus="ObjMFocus(this,'txtINVZIPCODES_4','txtINVOICEADDR_4');"  ></asp:TextBox>
                             <asp:TextBox ID="txtINVOICEADDR_4"   Text='<%# Eval("INVOICEADDR")%>'  runat="server" CssClass="txt_table" Width="150px"  MaxLength="100"  onblur="CheckMLength(this,'100');"  ></asp:TextBox>             
		                    </td>
		                    <td><asp:TextBox ID="txtORDERDAY_4"   Text='<%# Eval("ORDERDAY")%>' CssClass="txt_table" runat="server"></asp:TextBox></td>
		                    <td>
		                      <asp:DropDownList ID="drpINVKIND_4" runat="server">
                                <asp:ListItem Value="2">二聯式</asp:ListItem>
                                <asp:ListItem Value="3">三聯式</asp:ListItem>
                              </asp:DropDownList>
		                    </td>
		                    <td style="text-align:left">
		                    <asp:Button ID="btnBZ_4" CssClass="btn_normal" OnClientClick="return FrmML4004A_2Click2(this,'btnBZ_4','hdnBZ_4','tabInvoDtl_4');"   runat="server" Text="備註" />
                            <asp:HiddenField ID="hdnBZ_4"  Value='<%# Eval("BZ")%>' runat="server" />
		                    </td>
		                    <td><asp:Label ID="spanFGSPLIT_4"  Text='<%# Eval("FGSPLITNME")%>' runat="server"></asp:Label><asp:HiddenField ID="hdnFGSPLIT_4"  Value='<%# Eval("FGSPLIT")%>' runat="server" /></td>
		                    <td><asp:Label ID="spanFGSINGLE_4"  Text='<%# Eval("FGSINGLENME")%>' runat="server"></asp:Label><asp:HiddenField ID="hdnFGSINGLE_4"  Value='<%# Eval("FGSINGLE")%>' runat="server" /></td>
		                    <td><asp:Label ID="spanFGSUMMARY_4"  Text='<%# Eval("MTRCNTRNO")%>' runat="server"></asp:Label></td>
		                  </tr>
		                    </ItemTemplate>
		                    </asp:Repeater>
		                </table>                         
