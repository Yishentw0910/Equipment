<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmML1004.aspx.cs" Inherits="FrmML1004" %>
      ...
      <table width="100%" cellpadding="1" cellspacing="1" class="tab_query">
        ...
        <tr>
          <td style="text-align: center;" colspan="4">
            <asp:Button ID="cmdPrintReportA" runat="server" Text="列印核准書" CssClass="btn_normal"
              OnClientClick="javascipt:return cmdPrintA_onClick(this);" Width="100" />
            <asp:Button ID="cmdPrintReportB" style="display:none;" runat="server" Text="列印徵信報告書" CssClass="btn_normal"
