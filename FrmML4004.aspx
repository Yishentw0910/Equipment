<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmML4004.aspx.cs" Inherits="FrmML4004" %>
...
<body onkeydown="body_OnKeyDown(event)">
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="700">
      ...
      <tr>
        ...
        <br>
        <div class="divTitle" runat="server" style="display:none;" id="divTitle">預開發票資料維護查詢</div>
        <div class="div_Info H_130">
          <table width="100%" cellpadding="1" cellspacing="1" class="tab_query">
            ...
            <tr>
               <th>合約編號：</th>
               <td>
               <asp:TextBox ID="txtCNTRNO" onkeypress="OnlyNumDUCase(this);" runat="server" MaxLength="14" CssClass="txt_normal" Width="80%"></asp:TextBox></td>
               <th>撥款確認日起迄：</th>
               <td>
            ...
            <tr>
               <th>客戶統編：</th>
               <td colspan="3">
                 <asp:TextBox ID="txtCustID" runat="server" MaxLength="10" CssClass="txt_normal" Width="30%"></asp:TextBox>
        ...
        <div class="div_Info H_260" style="overflow:auto;margin:10px;">
           <table width="98%" cellpadding="0" cellspacing="0" class="tab_result" id="tabML4004" style="margin:4px;">
             <tr>
               <th width="5%">展開</th>
               <th width="18%">合約編號</th>
               <th width="25%">客戶名稱</th>
             ...
             <asp:Repeater ID="rptData" runat="server">
              <ItemTemplate>
               <tr  onmouseover="MouseOver(event)" onmouseout="MouseOut(event)" onclick="MouseDown(event);"> 
                 <td>
                     <asp:Button ID="btnSelect" CssClass="btn_normal"   OnClientClick='<%# String.Format("return CaseClick(\"{0}\",\"{1}\",\"{2}\",\"{3}\",\"{4}\",\"{5}\",\"{6}\",\"{7}\",this)", Eval("CASEID"), Eval("CUSTID"), Eval("COMPID"), Eval("CNTRNO"), Eval("TGRTCNT"), Eval("MAINTYPE"), Eval("MAINTYPENM"),Eval("PREINVSETID")) %>' Width="98%" runat="server" Text="明細" />
