...
<%@ page language="C#" autoeventwireup="true" codefile="FrmML1003A.aspx.cs" inherits="FrmML1003A" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
              ...
              &nbsp; &nbsp;
                    ...
                    <table class="divStatus" width="80%">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtCASEID" runat="server" CssClass="txt_readonly" Width="105px" ReadOnly="true"></asp:TextBox>
                            </td>
                            <th>申請日
                            </th>
                            <td>
                        ...
                        <div id="fraTab11" class="div_content padleft_0 T_-120" style="display: block">
                            <table cellpadding="1" cellspacing="1" class="tb_Info">
                                <tr>
                                    ...
                                    <td width="15%">
                                        <asp:TextBox ID="txtCUSTID" runat="server" CssClass="txt_readonly" ReadOnly="true" Width="85px"></asp:TextBox>
                                    </td>
                                    <th width="15%">客戶名稱
                                    </th>
                                    <td>
                                        <asp:TextBox ID="txtCUSTNAME" runat="server" Width="230px" CssClass="txt_readonly"
                                            ReadOnly="true">
                                        </asp:TextBox>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 客戶性質
                      ...
                      DataValueField="MCODE">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;設立日期
                  <asp:TextBox ID="txtCUSTCREATEDATE" runat="server" custprop="010" CssClass="txt_readonly"
                      ReadOnly="true">
                  </asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;集團實際負責人
                  <asp:TextBox ID="txtGROUPOWNER" runat="server" CssClass="txt_readonly"
                      ReadOnly="true">
                  </asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="drpORGATYPE" DataTextField="MNAME1" DataValueField="MCODE"
                                            runat="server" Width="150px" Enabled="false">
                                            <asp:ListItem>請選擇</asp:ListItem>
                                        </asp:DropDownList>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;上市櫃
                  <asp:DropDownList ID="drpLISTED" DataTextField="MNAME1" DataValueField="MCODE" runat="server"
                      ...
                      <asp:ListItem>請選擇</asp:ListItem>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPARENTCUSTNAME" runat="server" CssClass="txt_readonly" Width="276px"
                                            ReadOnly="true">
                                        </asp:TextBox>
                                    </td>
                                </tr>
                                                ...
                                                <asp:Repeater ID="rptContactI" runat="server">
                                                    <itemtemplate>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtINVZIPCODE" runat="server" Width="24px" Enabled="false" CssClass="txt_table"
                        ...
                        <div id="fraTab22" class="div_content padleft_0 T_-120" style="display: none">
                            <table cellpadding="1" cellspacing="1" class="tb_Info">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="drpPRINTSTORE" DataTextField="MNAME1" DataValueField="MCODE" runat="server" Enabled="false">
                                            <asp:ListItem Value="">請選擇</asp:ListItem>
                                    ...
                                    <asp:Repeater ID="rptMLDCASETARGETSTR" runat="server">
                                        <itemtemplate>
                                            <tr>
                                                ...
                                                <td width="350px">
                                                    <asp:TextBox ID="txtSTOREDZIPCODE" Enabled="false" runat="server" Width="24px" CssClass="txt_table"
          ...
          <!--Modify 20120601 By SS Gordon. Reason: 案件退回改為案件撤件.-->
                        ...
                        <asp:HiddenField ID="hidORGDEPID" runat="server" Value="" />
                    </div>
                </div>
            </contenttemplate>
        </asp:UpdatePanel>
