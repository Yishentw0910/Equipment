...
Modify 20120704 By Brent. Reason: 開放系統Text可以複製文字
...
Modify 20131115 By SS Leo     Reason:新擔保價值
Modify 20131210 BY    SEAN    Reason:修正不動產項次取號問題
Modify 20150202 By SS Vicky   Reason: 隱藏案件內容頁籤中，右方的[付款時間]及[承作真實IRR]
Modify 20150203 By SS Vicky   Reason: 承作內容的頁籤中，依是否為AR件顯示不同內容
Modify 20150205 By SS Vicky   Reason: 案件內容,隱藏[建議墊息款],增加[建議墊款息]
20160323 ADD BY SS ADAM REASON.新增案件產品別顯示，行業別顯示
Modify 20151130 BY SEAN       Reason:新增「NPV0」.「NPV0成本」隱藏欄位
...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmML6001B.aspx.cs" Inherits="FrmML6001B" %>
...
<body onload="window_onload()">
    <form id="form1" runat="server">
        <div id="divBody" class="divBody">
            ...
            <table class="divStatus" width="90%">
                <tr>
                    <th>
                        <b>合約編號</b>
                    </th>
                    ...
                    <td>
                        <asp:TextBox ID="txtCASEID" Width="105px" runat="server" CssClass="txt_readonly"
                            ReadOnly="true"></asp:TextBox>
                    </td>
                    <!--th>
          案件核准日
                ...
                <div id="fraTab11" class="div_content padleft_0 T_-120" style="display: none">
                    <table cellpadding="1" cellspacing="1" class="tb_Info">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtCUSTCREATECAPTIAL" custprop="100" runat="server" CssClass="txt_readonly_right"
                                    ReadOnly="true" Width="112px"></asp:TextBox>
                            </td>
                            <th>實收資本額
                            </th>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="drpORGATYPE" DataTextField="MNAME1" DataValueField="MCODE"
                                    runat="server" Enabled="false" Width="120px">
                                    <asp:ListItem>請選擇</asp:ListItem>
                                </asp:DropDownList>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;上市櫃
                        ...
                        <asp:TextBox ID="txtPARENTCUSTNAME" runat="server" CssClass="txt_readonly" ReadOnly="true"
                            Width="276px" Enabled="True" Visible="False"></asp:TextBox>
                        <%--                            </td>
                        </tr>--%>
                        <tr>
                            <th>公司登記地址
                                        ...
                                        <asp:Repeater ID="rptContactI" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtINVZIPCODE" runat="server" Width="24px" CssClass="txt_table"
                                                            Text='<%# Eval("INVZIPCODE")%>'></asp:TextBox>
                                                        <asp:TextBox ID="txtINVZIPCODES" runat="server" Width="120px" CssClass="txt_table"
                                                            Text='<%# Eval("INVZIPCODES")%>'></asp:TextBox>
                                                        <asp:TextBox ID="txtINVOICEADDR" runat="server" CssClass="txt_table" Width="150px"
                                                            Text='<%# Eval("INVOICEADDR")%>'></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox CssClass="txt_table_readonly" ReadOnly="true" ID="lblCONTACTTELCODE"
                                                            runat="server" Text='<%# Eval("CONTACTTELCODE")%>' Width="24px" />
                ...
                <div id="fraTab22" class="div_content padleft_0 T_-120" style="display: none">
                    <table cellpadding="1" cellspacing="1" class="tb_Info">
                        ...
                        <tr>
                            ...
                            <%--<td colspan="5">--%>
                            <asp:DropDownList ID="drpRECOURSE" runat="server" Visible="False">
                                <asp:ListItem Value="">請選擇</asp:ListItem>
                                <asp:ListItem Value="Y">是</asp:ListItem>
                                <asp:ListItem Value="N">否</asp:ListItem>
                            </asp:DropDownList>
...
<%--                        <div class="right_div" style="height: 265px;">
                            <table cellpadding="1" cellspacing="1" class="tb_Info">
                                <tr>
                                    <td colspan="2">--%>
                          <asp:RadioButton ID="rdoMLDCASEARDATA" Enabled="false" runat="server" Visible="True" Height="0px" Width="0px" /><%--應收帳款案件--%>
<%--                                    </td>
                                </tr>
                                <tr>
                                    <th>申請額度
                                ...
                                <tr>
                                    ...
                                    <td>--%>
                                        <asp:TextBox ID="txtACCOUNTSTERM" custprop="100" runat="server" CssClass="txt_readonly_right"
                                            ReadOnly="true" Visible="False"></asp:TextBox><%--月--%>
<%--                                    </td>
                                </tr>
                                <tr style="display: none">
                                    <%--UPD BY VICKY 20150202 隱藏付款時間
                                    <th>付款時間
                                    </th>
                                    <td>--%>
                                        <asp:DropDownList ID="drpPAYTIMEA" custprop="100" DataTextField="MNAME1" DataValueField="MCODE"
                                            Enabled="false" runat="server" Width="80%" Visible="False">
                                            <asp:ListItem>期初付</asp:ListItem>
                                            <asp:ListItem>期末付</asp:ListItem>
                                        </asp:DropDownList>
<%--                                    </td>
...
<%--                                    </td>
                    ...
                    <div style="clear: both;">
                        <table cellpadding="1" cellspacing="1" class="tb_Info">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtNPVRATECOST" custprop="001" runat="server" CssClass="txt_readonly_right" ReadOnly="true"  style="display: none;"></asp:TextBox>
                                </td>
                            </tr>
                ...
                <div id="fraTab33" class="div_content" style="display: none">
                    <div style="width: 97%; border: 1px solid #9FA1AD;">
                        <table cellpadding="1" cellspacing="1" class="tb_Info">
                            <tr>
                                ...
                                <td width="12%">
                                    <asp:TextBox ID="txtRMAINTYPE" CssClass="txt_readonly" runat="server" ReadOnly="true"></asp:TextBox>
                                </td>
                                <th width="12%">交易型態
                                </th>
                                <td>
                                    <asp:TextBox ID="txtRTRANSTYPE" CssClass="txt_readonly" runat="server" ReadOnly="true"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <th>動用情形
                                ...
                                <td>
                                    <asp:TextBox ID="txtRUSESTATUS" CssClass="txt_readonly" runat="server" ReadOnly="true"></asp:TextBox>
                                </td>
                                <th>案件來源
                                </th>
                                <td>
                    ...
                    <div id="divMainTypeA" runat="server">
                        <%--UPD BY VICKY 20150203 非AR件的承作內容--%>
                        <div style="width: 97%; border: 1px solid #9FA1AD; margin-top: 10px;">
                            <table cellpadding="1" cellspacing="1" class="tb_Info">
                                ...
                                <tr>
                                    ...
                                    <th width="12%">
                                        <!--Modify 20130819 By SS CHRIS FU  Reason:新增保險費按鈕-->
                                        <asp:Button ID="btINSURANCE1" CssClass="btn_normal" runat="server" Text="..." OnClick="btINSURANCE2_Click" />
                                        保險金
                                    </th>
                                    <td width="12%">
                                    ...
                                    <!--Modify 20130703 By SS Eric    Reason:新增保險異常欄位-->
                                    <th width="12%">
                                        <asp:CheckBox ID="txtRNOINSURANCEFLG" runat="server" />保險異常
                                    </th>
                                    <td></td>
                                    <th width="12%"></th>
                                    <td></td>
                                ...
                                <tr>
                                    <td>
                                        <asp:CheckBox ID="chkRDEPOSITLOANS2" runat="server" Checked="true" onclick="chkRDEP2_click(this);" />無存借款
                                    </td>
                                    <td colspan="3">
                                        <asp:CheckBox ID="chkRDEPOSITLOANS1" runat="server" onclick="chkRDEP1_click(this);" />借款給供應商
                                        <asp:CheckBox ID="chkRDEPOSITLOANS0" runat="server" onclick="chkRDEP0_click(this);" />存款在本公司
                                    </td>
                                    <td colspan="4">存借款<asp:TextBox ID="txtRDEPOSITLOANSAMOUNT" Text="0" onkeypress="OnlyNum(this);"
                                ...
                                <tr>
                                    <td colspan="8">供應商
                                        <asp:TextBox ID="txtDSUPPLIER" runat="server" MaxLength="10" Width="80px" onkeypress="OnlyNumDUCase(this);"
                                            onblur="DSUPPLIERID_onblur(this);" CssClass="txt_normal"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txtSUPPLIERSALE" runat="server" MaxLength="10" Width="80px" onkeypress="OnlyNumDUCase(this);"
                                            onblur="idBlur(this);" CssClass="txt_normal"></asp:TextBox>
                                        供應商業代姓名
                        ...
                        <div style="width: 97%; border: 1px solid #9FA1AD; margin-top: 10px;">
                            <table cellpadding="1" cellspacing="1" class="tb_Info">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtSHOWPAYACCOUNT" runat="server" CssClass="txt_normal" Width="300px"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div id="divMainTypeB" runat="server" style="display: none;">
                        <%--UPD BY VICKY 20150203 AR件的承作內容--%>
                        <div style="width: 97%; border: 1px solid #9FA1AD; margin-top: 10px;">
                            <table cellpadding="1" cellspacing="1" class="tb_Info">
                                <tr>
                                    <th width="15%">總受讓金額
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPAYDATE_AR" custprop="010" CssClass="txt_readonly" ReadOnly="true"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtDEPOSITBANK_AR" Text='<%# Eval("DEPOSITBANK")%>' runat="server"
                                                    CssClass="txt_readonly" ReadOnly="true" Width="240px"></asp:TextBox>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtBILLEXPIRYDT_AR" Text='<%# Eval("BILLEXPIRYDT")%>' runat="server"
                                                    CssClass="txt_readonly" ReadOnly="true" Width="80px"></asp:TextBox>
                                            </td>
                                            <td>
                    ...
                    <div style="width: 97%; border: 1px solid #9FA1AD; margin-top: 10px;">
                        <table cellpadding="1" cellspacing="1" class="tb_Info">
                            ...
                            <tr>
                                ...
                                <td colspan="6">
                                    <asp:TextBox ID="txtRNPVRATECOST" runat="server" Text="0.0" CssClass="txt_readonly_right" ReadOnly="true"  style="display: none;"></asp:TextBox>
                                    <%--%--%>
                                </td>
                            </tr>
                            <tr style="display: none;">
                            ...
                            <tr>
                                <td colspan="6" style="text-align: center; height: 30px;">
                                    <asp:Button ID="Button4" runat="server" CssClass="btn_normal" Enabled="false" Text="試算"
                                        Style="display: none" />&nbsp;
                                </td>
                            </tr>
                        </table>
		  	...
		  	<asp:Button ID="Button3211" runat="server" CssClass="btn_normal" Text="標的物匯入" />--%>
                    <div class="div_table" style="overflow-x: scroll; height: 200px">
                        <table class="tb_Contact" style="width: 1500px;">
                            <tr>
                                <th>項次
                                </th>
                                <th>標的物種類
                            ...
                            <asp:Repeater ID="rptMLDCASETARGET" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <%--Modify 20131001 By SS Eric    Reason:在標的物頁籤中，標的物的GRID增加製造廠商，廠牌，單位，數量--%>
                                        <td>
                                            <asp:Label ID="txtMANUFACTURER" Text='<%# Eval("MANUFACTURER")%>' runat="server"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label ID="txtTARGETBRAND" Text='<%# Eval("TARGETBRAND")%>' runat="server"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label ID="txtTARGETUNIT" Text='<%# Eval("TARGETUNIT")%>' runat="server"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label ID="txtTARGETCOUNT" Text='<%# Eval("TARGETCOUNT")%>' runat="server"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="350px">
                                            ...
                                            <asp:TextBox ID="txtSTOREDZIPCODES" runat="server" Width="120px" CssClass="txt_table"
                                                Text='<%# Eval("STOREDZIPCODES")%>'></asp:TextBox>
                ...
                <div id="fraTab55" class="div_content T_-130" style="display: none">
                            ...
                            <asp:Repeater ID="rptMLDCASEGUARANTEE" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <%--Modify 20120601 By SS Gordon. Reason: 保證人擴欄位：生日、性別、與申戶關係、戶籍地址、通訊地址、聯絡電話、職業、任職公司--%>
                                        <td>
                                            <asp:TextBox ID="txtGRTBIRDT" Text='<%# Eval("GRTBIRDT") %>' runat="server" Width="80px"
                                                CssClass="txt_table" onfocus="dateFocus(this)" onblur="dateBlur(this);"></asp:TextBox>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtGRTRESIDENTZIP" Text='<%# Eval("GRTRESIDENTZIP") %>' runat="server"
                                            ...
                                            <input type="button" id="btnGRTRESIDENTZIP" disabled="disabled" class="btn_normal"
                                                ...
                                                value="&#8230;" />
                                            <asp:TextBox ID="txtGRTRESIDENTZIPNM" Text='<%# Eval("GRTRESIDENTZIPNM") %>' runat="server"
                                                Width="120px" onfocus="ObjMFocus(this,'txtGRTRESIDENTZIPNM','txtGRTRESIDENTADDR');"
                                                CssClass="txt_table"></asp:TextBox>
                                            <asp:TextBox ID="txtGRTRESIDENTADDR" Text='<%# Eval("GRTRESIDENTADDR") %>' runat="server"
                                                Width="150px" CssClass="txt_table" onblur="CheckMLength(this,'100','發票寄送地');"
                                                MaxLength="100"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtGRTZIP" Text='<%# Eval("GRTZIP") %>' runat="server" Width="24px"
                                                MaxLength="6" onkeypress="OnlyNum(this);" onblur="PostCodeBlure(this)" CssClass="txt_table"></asp:TextBox>
                                            ...
                                            <asp:TextBox ID="txtGRTZIPNM" Text='<%# Eval("GRTZIPNM") %>' runat="server" Width="120px"
                                                onfocus="ObjMFocus(this,'txtGRTZIPNM','txtGRTADDR');" CssClass="txt_table"></asp:TextBox>
                                            <asp:TextBox ID="txtGRTADDR" Text='<%# Eval("GRTADDR") %>' runat="server" Width="150px"
                                                CssClass="txt_table" onblur="CheckMLength(this,'100','發票寄送地');" MaxLength="100"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtGRTTELCODE" Text='<%# Eval("GRTTELCODE") %>' runat="server" Width="24px"
                                                CssClass="txt_table" onkeypress="OnlyNum(this);" onblur="OnlyNumBlur(this);"></asp:TextBox>
                                            <asp:TextBox ID="txtGRTTEL" Text='<%# Eval("GRTTEL") %>' runat="server" Width="80px"
                                                CssClass="txt_table" onkeypress="OnlyNum(this);" onblur="OnlyNumBlur(this);"></asp:TextBox>
                                            <asp:TextBox ID="txtGRTTELEXT" Text='<%# Eval("GRTTELEXT") %>' runat="server" Width="40px"
                                                CssClass="txt_table" onkeypress="OnlyNum(this);" onblur="OnlyNumBlur(this);"></asp:TextBox>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtGRTCOMPANY" Text='<%# Eval("GRTCOMPANY") %>' runat="server" Width="200px"
                                                CssClass="txt_table"></asp:TextBox>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            ...
                            <asp:Repeater ID="rptMLDCASEMOVABLE" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtMOVABLENAME" Text='<%# Eval("MOVABLENAME")%>' runat="server"
                                                CssClass="txt_table"></asp:TextBox>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtMOVABLEZIPCODE" runat="server" Width="24px" CssClass="txt_table"
                                                Text='<%# Eval("MOVABLEZIPCODE")%>'></asp:TextBox>
                                            <asp:TextBox ID="txtMOVABLEZIPCODES" runat="server" Width="120px" CssClass="txt_table"
                                                Text='<%# Eval("MOVABLEZIPCODES")%>'></asp:TextBox>
                                            <asp:TextBox ID="txtMOVABLEADDR" runat="server" CssClass="txt_table" Width="150px"
                                                Text='<%# Eval("MOVABLEADDR")%>'></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtMOVABLENO" Text='<%# Eval("MOVABLENO")%>' runat="server" CssClass="txt_table"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtMOVABLEYEAR" Text='<%# Eval("MOVABLEYEAR")%>' runat="server"
                                                CssClass="txt_table"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtMOVABLEBUYDATE" Text='<%# Itg.Community.Util.GetRepYear(Eval("MOVABLEBUYDATE").ToString()) %>'
                                                runat="server" CssClass="txt_table"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtMOVABLENEWAMT" Text='<%# Itg.Community.Util.NumberFormat(Eval("MOVABLENEWAMT").ToString()) %>'
                                                runat="server" CssClass="txt_table_right"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtMOVABLEBUYAMT" Text='<%# Itg.Community.Util.NumberFormat(Eval("MOVABLEBUYAMT").ToString()) %>'
                                                runat="server" CssClass="txt_table_right"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtMOVABLERESIDUALS" Text='<%#  Itg.Community.Util.NumberFormat(Eval("MOVABLERESIDUALS").ToString()) %>'
                                                runat="server" CssClass="txt_table_right"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtMOVABLERESETPRICE" Text='<%#  Itg.Community.Util.NumberFormat(Eval("MOVABLERESETPRICE").ToString()) %>'
                                                runat="server" CssClass="txt_table_right"></asp:TextBox>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            ...
                            <asp:Repeater ID="rptMLDCASEIMMOVABLE" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtIMMOVABLEOWNER" Text='<%# Eval("IMMOVABLEOWNER")%>' runat="server"
                                                CssClass="txt_table"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtIMMOVABLEOWNERID" Text='<%# Eval("IMMOVABLEOWNERID")%>' runat="server"
                                                CssClass="txt_table"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtIMMOVABLEGETDATE" Text='<%# Itg.Community.Util.GetRepYear(Eval("IMMOVABLEGETDATE").ToString()) %>'
                                                runat="server" CssClass="txt_table"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtIMMOVABLEBUILDDATE" Text='<%# Itg.Community.Util.GetRepYear(Eval("IMMOVABLEBUILDDATE").ToString()) %>'
                                                runat="server" CssClass="txt_table"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtIMMOVABLESECTOR" Text='<%# Eval("IMMOVABLESECTOR")%>' runat="server"
                                                CssClass="txt_table"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtIMMOVABLEBUILD" Text='<%# Eval("IMMOVABLEBUILD")%>' runat="server"
                                                CssClass="txt_table"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtIMMOVABLEAREA" Text='<%# Eval("IMMOVABLEAREA")%>' runat="server"
                                                CssClass="txt_table_right"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtIMMOVABLEBUILDNO" Text='<%# Eval("IMMOVABLEBUILDNO")%>' runat="server"
                                                CssClass="txt_table"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtIMMOVABLEHOUSENUM" Text='<%# Eval("IMMOVABLEHOUSENUM")%>' runat="server"
                                                CssClass="txt_table"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtIMMOVABLEBUILDAREA" Text='<%# Eval("IMMOVABLEBUILDAREA")%>' onblur="areacon(this)"
                                                runat="server" CssClass="txt_table_right"></asp:TextBox>
                                        </td>
                                        <td>
                        ...
                        <asp:Repeater ID="rptMLDHUMANRIGHTS" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtHUMANRIGHTS" Text='<%# Eval("HUMANRIGHTS") %>' runat="server"
                                            CssClass="txt_table"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtREGISTDATE" Text='<%# Itg.Community.Util.GetRepYear(Eval("REGISTDATE").ToString()) %>'
                                            runat="server" CssClass="txt_table"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtSETPRICE" Text='<%# Itg.Community.Util.NumberFormat(Eval("SETPRICE").ToString()) %>'
                                            runat="server" CssClass="txt_table_right"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtCREDITOR" Text='<%# Eval("CREDITOR") %>' runat="server" CssClass="txt_table"></asp:TextBox>
                                    </td>
                                    <td>
                    ...
                    <table class="tb_Contact" width="85%">
                        ...
                        <asp:Repeater ID="rptMLDCASEADEPOSIT" runat="server">
                            <ItemTemplate>
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtDEPOSITBANKS" CssClass="txt_normal" Text='<%# Eval("DEPOSITBANKS") %>'
                                            Width="120px" runat="server"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtDEPOSITNBR" Text='<%# Eval("DEPOSITNBR") %>' runat="server" CssClass="txt_table"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtDEPOSITAMT" Text='<%#  Itg.Community.Util.NumberFormat(Eval("DEPOSITAMT").ToString()) %>'
                                            runat="server" CssClass="txt_table_right"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtDEPOSITSTARTDATE" Text='<%# Itg.Community.Util.GetRepYear(Eval("DEPOSITSTARTDATE").ToString()) %>'
                                            runat="server" CssClass="txt_table"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtDEPOSITDUEDATE" Text='<%# Itg.Community.Util.GetRepYear(Eval("DEPOSITDUEDATE").ToString()) %>'
                                            runat="server" CssClass="txt_table"></asp:TextBox>
                                    </td>
                                </tr>
                            </ItemTemplate>
                    ...
                    <table class="tb_Contact" width="80%">
                        ...
                        <asp:Repeater ID="rptMLDCASEBILLNOTE" runat="server">
                            <ItemTemplate>
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtBILLNOTEDATE" Text='<%#  Itg.Community.Util.GetRepYear(Eval("BILLNOTEDATE").ToString()) %>'
                                            runat="server" CssClass="txt_table" Width="80px"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtBILLNOTEBANKS" CssClass="txt_normal" Text='<%# Eval("BILLNOTEBANKS") %>'
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtBILLNOTENBR" Text='<%# Eval("BILLNOTENBR") %>' runat="server"
                                            CssClass="txt_table" Width="60px"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtACCOUNT" Text='<%# Eval("ACCOUNT") %>' runat="server" CssClass="txt_table"
                                            Width="60px"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtBILLNOTECUSTNAME" Text='<%# Eval("BILLNOTECUSTNAME") %>' runat="server"
                                            CssClass="txt_table" Width="80px"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtBILLNOTEAMT" Text='<%# Itg.Community.Util.NumberFormat(Eval("BILLNOTEAMT").ToString()) %>'
                                            runat="server" CssClass="txt_table_right" Width="60px"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtBILLNOTENOTE" Text='<%# Eval("BILLNOTENOTE") %>' runat="server"
                                            CssClass="txt_table"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtBILLNOTEBACKDATE" Text='<%#  Itg.Community.Util.GetRepYear(Eval("BILLNOTEBACKDATE").ToString()) %>'
                    ...
                    <table class="tb_Contact" width="70%">
                        ...
                        <asp:Repeater ID="rptMLDCASESTOCK" runat="server">
                            <ItemTemplate>
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtSTOCKDATE" Text='<%#  Itg.Community.Util.GetRepYear(Eval("STOCKDATE").ToString()) %>'
                                            runat="server" CssClass="txt_table"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtSTOCKNAME" Text='<%# Eval("STOCKNAME") %>' runat="server" CssClass="txt_table"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtSTOCKPROVIDER" Text='<%# Eval("STOCKPROVIDER") %>' runat="server"
                                            CssClass="txt_table"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtSTOCKUNIT" Text='<%# Eval("STOCKUNIT") %>' runat="server" CssClass="txt_table"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtSTOCKQUANTITY" Width="50px" Text='<%# Eval("STOCKQUANTITY") %>'
                                            runat="server" CssClass="txt_table"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtSTOCKTOTAL" Width="60px" Text='<%# Eval("STOCKTOTAL") %>' runat="server"
                                            CssClass="txt_table"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtSTOCKBEGIN" Text='<%# Eval("STOCKBEGIN") %>' runat="server" CssClass="txt_table"
                                            Width="60px"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtSTOCKEND" Text='<%# Eval("STOCKEND") %>' runat="server" CssClass="txt_table"
                                            Width="60px"></asp:TextBox>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtSTOCKNOTE" Text='<%# Eval("STOCKNOTE") %>' runat="server" CssClass="txt_table"></asp:TextBox>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
                    ...
                    <br />
                    其他<br />
                    <asp:TextBox ID="txtOTHERCOND" runat="server" CssClass="txt_normal" Width="80%"></asp:TextBox>
                </div>
                <%--擔保條件End --%>
                <%--撥款申請Begin --%>
                <div id="fraTab66" class="div_content T_-120" style="display: none">
                    <table cellpadding="1" cellspacing="1" class="tb_Info" style="margin-left: -5px;">
                        <tr>
                            ...
                            <td width="11%">
                                <!--Modify 20120704 By Brent. Reason: 加入「案件迄租日」-->
                                <asp:TextBox ID="txtPRENTENDT" custprop="010" runat="server" CssClass="txt_readonly"
                                    ReadOnly="true"></asp:TextBox>
                            </td>
                            <th width="10%">客戶首期繳納日
                            </th>
                    ...
                    <div class="div_table" style="overflow: auto; height: 100px">
                        <table class="tb_Contact" width="1500px">
                            <tr>
                                <th>項次
                                </th>
                                <th>憑證號碼
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtCERTIFICATENO" Text='<%# Eval("CERTIFICATENO")%>' runat="server"
                                                Width="96px" CssClass="txt_table"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtINVDATE" Text='<%# Itg.Community.Util.GetRepYear(Eval("INVDATE").ToString())%>'
                                                Width="80px" runat="server" CssClass="txt_table"></asp:TextBox>
                                        </td>
                                        <td>
