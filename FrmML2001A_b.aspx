...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmML2001A_b.aspx.cs" Inherits="FrmML2001A_b" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
             <ContentTemplate>
              <table style="margin:0 auto; background-color:#add8e6" border="1" cellpadding="1" cellspacing="1"width="500">
                  <tr>
                      <td style="background-color: #ffcc99; text-align: center" colspan="2"><B>婉拒原因(可複選)</B></td>
                  </tr>
                  <tr>
                      ...
                      <td style="text-align: left" class="style7">
                          ...
                          <asp:CheckBox ID="A005" runat="server" AutoPostBack="True"   Text="過度擴充"/><br/>
                          <asp:CheckBox ID="A006" runat="server" AutoPostBack="True"   Text="誠信問題"/><br/>
                          <asp:CheckBox ID="A007" runat="server" AutoPostBack="True"   Text="重複融資"/><br/>
                          <asp:CheckBox ID="A008" runat="server" AutoPostBack="True"   Text="申戶票/債信異常"/><br/>
                          <asp:CheckBox ID="A009" runat="server" AutoPostBack="True"   Text="申戶不動產有民間設定"/><br/>
                          <asp:CheckBox ID="A010" runat="server" AutoPostBack="True"   Text="申戶不動產有限制登記"/><br/>
                      </td>
                  </tr>
                  <tr>
                      <td style="text-align: center" class="style8">借款目的</td>
                      <td style="text-align: left" class="style7">
                          <asp:CheckBox ID="B001" runat="server" AutoPostBack="True"   Text="資金流向不明"/><br/>
                          <asp:CheckBox ID="B002" runat="server" AutoPostBack="True"   Text="資金流向大陸不易評估"/><br/>
                  ...
                  <tr>
                      ...
                      <td style="text-align: left" class="style7">
                          ...
                          <asp:CheckBox ID="C004" runat="server" AutoPostBack="True"   Text="同業客票擔保未兌現"/><br/>
                          <asp:CheckBox ID="C005" runat="server" AutoPostBack="True"   Text="原融(財務欠佳)"/><br/>
                          <asp:CheckBox ID="C006" runat="server" AutoPostBack="True"   Text="申戶房貸遲繳"/><br/>
                          <asp:CheckBox ID="C007" runat="server" AutoPostBack="True"   Text="申戶有民間資金借貸"/><br/>
                      </td>
                  </tr>
                  <tr>
                      <td style="text-align: center" class="style8">債權保障</td>
                      <td style="text-align: left" class="style7">
                          <asp:CheckBox ID="D001" runat="server" AutoPostBack="True"   Text="個人背景複雜、債信瑕疵"/><br/>
                          <asp:CheckBox ID="D002" runat="server" AutoPostBack="True"   Text="保人卡循嚴重"/><br/>
                          <asp:CheckBox ID="D003" runat="server" AutoPostBack="True"   Text="保人有現金卡或預借現金"/><br/>
                          <asp:CheckBox ID="D004" runat="server" AutoPostBack="True"   Text="保人原融(財務欠佳)"/><br/>
                          <asp:CheckBox ID="D005" runat="server" AutoPostBack="True"   Text="保人信用卡/房貸遲繳"/><br/>
                          <asp:CheckBox ID="D006" runat="server" AutoPostBack="True"   Text="保人無資產"/><br/>
                          <asp:CheckBox ID="D007" runat="server" AutoPostBack="True"   Text="保人票/債信異常"/><br/>
                          <asp:CheckBox ID="D008" runat="server" AutoPostBack="True"   Text="保人不動產有民間設定"/><br/>
                          <asp:CheckBox ID="D009" runat="server" AutoPostBack="True"   Text="保人不動產有限制登記"/><br/>
                          <asp:CheckBox ID="D010" runat="server" AutoPostBack="True"   Text="本公司授信異常戶"/><br/>
                      </td>
                  </tr>
                  <tr>
                      ...
                      <td style="text-align: left" class="style7">
                          ...
                          <asp:CheckBox ID="E006" runat="server" AutoPostBack="True"   Text="負責人資歷有限"/><br/>
                      </td>
                  </tr>
                  <tr>
                      <td style="text-align: center" class="style8">其他</td>
                      <td style="text-align: left" class="style7">
                          <asp:CheckBox ID="F001" runat="server" AutoPostBack="True"   Text="業務自行撤件(客戶狀況不佳)"/><br/>
                          <asp:CheckBox ID="F002" runat="server" AutoPostBack="True"   Text="業務自行撤件(客戶資料不齊)"/><br/>
                          <asp:CheckBox ID="F003" runat="server" AutoPostBack="True"   Text="業務自行撤件(操作方式錯誤)"/><br/>
              ...
              <table>
                  <tr>      
	        	    <td>				
                    <asp:Button ID="cmdSURE" runat="server" Text="確定" TabIndex="4" OnClick="cmdSURE_Click"/>
                    <asp:Button ID="cmdBACK" runat="server" Text="關閉" TabIndex="5" OnClick="cmdBACK_Click" />
                    </td>
                  </tr>    
             </table>
