<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmMLSelect_Bank.aspx.cs"
  Inherits="FrmMLSelect_Bank" %>
...
<head runat="server">
  ...
  <script type="text/javascript">      
     <!-- #Include file='js/Select_Bank.js' -->                   
  </script>
  ...
  <div>
    ...
    <div class="div_Info4">
      <table width="100%" cellpadding="1" cellspacing="1" class="tab_query">
        <tr>
          ...
          <td width="30%">
            <asp:TextBox ID="txtBankID" runat="server" CssClass="txt_normal" Width="80%"></asp:TextBox>
          </td>
          <th width="20%">
            銀行名：
          </th>
          <td>
            <asp:TextBox ID="txtBankName" runat="server" CssClass="txt_normal" Width="80%"></asp:TextBox>
          </td>
        </tr>
        <tr>
    ...
    <div class="div_Info4 H_260" style="overflow: auto">
      <asp:GridView ID="grvData" runat="server" AutoGenerateColumns="False" Width="98%"
        ...
        <Columns>
          <asp:BoundField DataField="BANKID" HeaderText="代碼">
            <ItemStyle Width="40%" />
          </asp:BoundField>
          <asp:BoundField DataField="BANKNM" HeaderText="銀行名" />
        </Columns>
      </asp:GridView>
    </div>
    <div class="btn_div">
