<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmML4014.aspx.cs" Inherits="FrmML4014" %>
  ...
  <form id="form1" runat="server">
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="700">
      ...
      <tr>
        ...
        <br>
        <div class="divTitle" runat="server" style="display:none;" id="divTitle" >銀行件展期維護</div>
             ...
             <asp:Repeater ID="rptData" runat="server">
              <ItemTemplate>
               <tr class="singleline"  onmouseover="MouseOver(event)" onmouseout="MouseOut(event)" onclick="MouseDown(event);"> 
                 <td>
                     <asp:Button ID="btnSelect" CssClass="btn_normal"   OnClientClick='<%# String.Format("return CaseClick(\"{0}\",\"{1}\",\"{2}\",\"{3}\",\"{4}\",\"{5}\",\"{6}\",this)", Eval("CASEID"), Eval("CUSTID"), Eval("COMPID"), Eval("CNTRNO"), Eval("MAINTYPE"), Eval("MAINTYPENM"),Eval("BANKEXPAND")) %>' Width="95%" runat="server" Text="明細" />
