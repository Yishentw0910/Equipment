...
public partial class FrmML2001 : PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            if (!IsPostBack)
            {
                ...
                //陳莉芳(員編30077)新增徵審權限
                if (GSTR_U_USERID == "30077")
                {
                    GSTR_DEPTID = "AI00";
                    //Alert(GSTR_U_USERID+" "+GSTR_DEPTID);
                }
                ...
                {
                    this.drpCreditChecking.SelectedValue = "A";
                }
    ...
    private void drpCreditCheckingBind()
    {
        ...
        try
        {
            ...
            if (GSTR_DEPTID == "AB00" || GSTR_DEPTID == "AD00")    //企劃與IT可看全部
            {
                this.drpCreditChecking.Items.Add(new ListItem("全部", ""));
                this.drpCreditChecking.Items.Add(new ListItem("客服審核件", "AI00"));
                this.drpCreditChecking.Items.Add(new ListItem("營業單位自審件", "A"));
            }
            else if (GSTR_DEPTID == "AI00")   //徵審
            {
                this.drpCreditChecking.Items.Add(new ListItem("客服審核件", "AI00"));
            }
            else //營業單位自審
    ...
    private String GenerateQueryCon()
    {
        ...
        try
        {
            ...
            {
                if (this.drpCreditChecking.SelectedValue == "A")
                {
                    LSTR_QueryCon += " AND  [MLMCASE].[ORGDEPID]= ''" + GSTR_DEPTID + "''";
                }
                else
                {
