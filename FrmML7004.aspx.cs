...
public partial class FrmML7004 : PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        GetUsrAndFuncInfo();
        //===== for 測試Menu =====
        if (GSTR_PROGNM == "") GSTR_PROGNM = "保險費用轉檔作業";
        if (GSTR_A_PRGID == "") GSTR_A_PRGID = "ML7004";
        if (GSTR_U_PRGID == "") GSTR_U_PRGID = "ML7004";
        //========================             
        if (!IsPostBack)
        {
            //綁定公司別下拉
    ...
    private void TransData()
    {
        ...
        //案件主鍵
        LSTR_Data.Append("SP_ML7004_I02" + GSTR_ColDelimitChar);
