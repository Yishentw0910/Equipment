...
20121107 Add By Maureen Reason:登打保人條件時，系統依個人或法人判別，非必要之登打條件以反灰呈現。加入OnSelectedIndexChanged控制項。
...
<%@ page language="C#" autoeventwireup="true" codefile="FrmML1002.aspx.cs" inherits="FrmML1002" enableeventvalidation="false" %>
                    ...
                    <table class="divStatus" width="98%">
                        <tr>
                            <td width="36%">
                                ...
                                <asp:Button ID="btnSelect" runat="server" Text="查詢" CssClass="btn_normal" OnClientClick="return CaseClick('S')" />
                                <asp:Button ID="btnLoadCase" runat="server" Text="載入舊案" CssClass="btn_normal" OnClientClick="return CaseInsertClick()" OnClick="btnLoadCase_Click" Width="70px" />
                                ...
                                <!--20140516 ADD BY SS ADAM REASON.增加舊案載入 -->
                                <asp:HiddenField ID="hidOLDCASEID" runat="server" Value="" />
                            </td>
                            <th width="11%">案件編號
                            </th>
                            <td width="13%">
                                                    ...
                                                    <table id="tblContactC" class="tb_Contact" width="100%">
                                                        ...
                                                        <asp:Repeater ID="rptContactC" runat="server">
                                                            <itemtemplate>
                                                                <tr>
                                                                    <td>
                                                                        <asp:Button ID="btnMainDel" runat="server" Text="刪" OnClientClick="return ContactDelete('2',this)" Enabled='<%# btnDelEnable() %>' CssClass="btn_normal" Width="24px" />
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox CssClass="txt_table_readonly" ReadOnly="true" ID="lblCONTACTNAME" runat="server" Text='<%# Eval("CONTACTNAME")%>' Width="60px"></asp:TextBox>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox CssClass="txt_table_readonly" ReadOnly="true" ID="lblCONTACTTELCODE" runat="server" Text='<%# Eval("CONTACTTELCODE")%>' Width="24px" />
                                                                        <asp:TextBox CssClass="txt_table_readonly" ReadOnly="true" ID="lblCONTACTTEL" runat="server" Text='<%# Eval("CONTACTTEL")%>' Width="80px"></asp:TextBox>
                                                                        <asp:TextBox CssClass="txt_table_readonly" ReadOnly="true" ID="lblCONTACTTELEXT" runat="server" Text='<%# Eval("CONTACTTELEXT")%>' Width="24px" />
                                                                    </td>
                                                                    <td>
                                                    ...
                                                    <table id="tblContactI" class="tb_Contact" width="150%;">
                                                        ...
                                                        <asp:Repeater ID="rptContactI" runat="server">
                                                            <itemtemplate>
                                                                <tr>
                                                                    <td>
                                                                        <asp:Button ID="btnMainDel" runat="server" Text="刪" OnClientClick="return ContactDelete('3',this)" Enabled='<%# btnDelEnable() %>' CssClass="btn_normal" Width="24px" />
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox CssClass="txt_table_readonly" ReadOnly="true" ID="lblCONTACTNAME" runat="server" Text='<%# Eval("CONTACTNAME")%>' Width="60px"></asp:TextBox>
                                                                    </td>
                ...
                <td >--%>
                                    ...
                                    <td>
                                        <asp:UpdatePanel ID="UpdatePaneldrpTRANSTYPE" runat="server" UpdateMode="Conditional">
                                            <contenttemplate>
                                                <%--20231130交易型態改不可選--%>
                                                <asp:DropDownList ID="drpTRANSTYPE" DataTextField="MNAME1" DataValueField="MCODE" class="bg_F5F8BE" runat="server" OnSelectedIndexChanged="drpTRANSTYPE_SelectedIndexChanged" AutoPostBack="true" Enabled="false">
                                                </asp:DropDownList>
                                            </contenttemplate>
                                        </asp:UpdatePanel>
                                    </td>
                  ...
                  <!-- 20160321 ADD BY SS ADAM REASON.新增案件產品別 END-->
                            ...
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                    ...
                                    <div>
                                        <div>
                                            <table class="tb_Info" cellpadding="1" cellspacing="1">
                                                <tr>
                                                    <td colspan="5">
                                                        <asp:RadioButton ID="rdoMLDCASEINST" Enabled="false" runat="server" />
                                                        分期&#12289;租賃案件
                                                    </td>
                                                    <!--Modify 20130326 By SS Eric    Reason:新增保險異常欄位-->
                                                    <td colspan="1">
                                                        <!--Modify 20130819 By SS CHRIS FU  Reason:新增保險異常事件-->
                                                        <asp:CheckBox ID="txtNOINSURANCEFLG" Enabled="false" runat="server" onblur="txtTARGETPRICE_onblur(txtTARGETPRICE);" OnCheckedChanged="txtNOINSURANCEFLG_CheckedChanged" />
                                                        保險異常
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <span style="color: red">若要更改標的物金額<br />
                                                            請至「標的物」標籤中調整標的物價格</span>
                                                    </td>
                                                    <th width="12%">
                                                ...
                                                <tr>
                                                    <th>期付款推算功能</th>
                                                    <td>
                                                        <asp:TextBox ID="txtIRR1" onfocus="txtPRINCIPAL_Click(this);" onkeyup="this.value=this.value.replace(/^\D*(\d*(?:\.\d{0,1})?).*$/g, '$1')" MaxLength="4" runat="server" CssClass="txt_normal_right" TEXT="請輸入IRR"></asp:TextBox>
                                                        <asp:UpdatePanel ID="UpdatePanel9" runat="server" UpdateMode="Conditional">
                                                            <contenttemplate>
                                                                <asp:Button ID="btnPRINCIPAL" runat="server" CssClass="btn_normal" Text="試算" AutoPostBack="false" OnClick="btnPRINCIPAL_Click" />
                                                            </contenttemplate>
                                                        </asp:UpdatePanel>
                                                    </td>
                                                    <th colspan="1">預估期付款(含稅)</th>
                                                    <td>
                                                        <asp:UpdatePanel ID="UpdatePanel10" runat="server" UpdateMode="Conditional">
                                                            <contenttemplate>
                                                                <asp:TextBox ID="txtPRINCIPAL" onkeypress="OnlyNum(this);" onblur="MoneyBlur(this);" MaxLength="9" runat="server" CssClass="txt_readonly_right" ReadOnly="true"></asp:TextBox>
                                                            </contenttemplate>
                                                        </asp:UpdatePanel>
                                                    </td>
                                                    <td colspan="2"></td>
                                                    ...
                                                    <td colspan="6">
                                                        <table class="tb_grid" width="100%">
                                                            <tr>
                                                                ...
                                                                <td width="15%">- 第<asp:TextBox ID="txtENDPAY1" onkeypress="OnlyNum(this);" onblur="checkPayE(this,'');" MaxLength="9" runat="server" CssClass="txt_must_right" Width="24px"></asp:TextBox>
                                                                    期
                                                                </td>
                                                                <td width="18%">期付款(未稅)
                                                                </td>
                                ...
                                <asp:TextBox ID="txtSTARTPAY2" onkeypress="OnlyNum(this);" onblur="checkPayS(this,'txtENDPAY1','txtENDPAY2');" MaxLength="9" runat="server" CssClass="txt_table_right" Width="24px"></asp:TextBox>
                                                                ...
                                                                <td>- 第<asp:TextBox ID="txtENDPAY2" onkeypress="OnlyNum(this);" onblur="checkPayE(this,'txtSTARTPAY2');" MaxLength="9" runat="server" CssClass="txt_table_right" Width="24px"></asp:TextBox>
                                                                    期
                                                                </td>
                                                                <td>期付款(未稅)
                                                                </td>
                                ...
                                <asp:TextBox ID="txtSTARTPAY3" onkeypress="OnlyNum(this);" onblur="checkPayS(this,'txtENDPAY2','txtENDPAY3');" MaxLength="9" runat="server" CssClass="txt_table_right" Width="24px"></asp:TextBox>
                                                                ...
                                                                <td>- 第<asp:TextBox ID="txtENDPAY3" onkeypress="OnlyNum(this);" onblur="checkPayE(this,'txtSTARTPAY3');" MaxLength="9" runat="server" CssClass="txt_table_right" Width="24px"></asp:TextBox>
                                                                    期
                                                                </td>
                                                                <td>期付款(未稅)
                                                                </td>
                                ...
                                <asp:TextBox ID="txtSTARTPAY4" onkeypress="OnlyNum(this);" onblur="checkPayS(this,'txtENDPAY3','txtENDPAY4');" MaxLength="9" runat="server" CssClass="txt_table_right" Width="24px"></asp:TextBox>
                                                                ...
                                                                <td>- 第<asp:TextBox ID="txtENDPAY4" onkeypress="OnlyNum(this);" onblur="checkPayE(this,'txtSTARTPAY4');" MaxLength="9" runat="server" CssClass="txt_table_right" Width="24px"></asp:TextBox>
                                                                    期
                                                                </td>
                                                                <td>期付款(未稅)
                                                                </td>
                    ...
                    <table cellpadding="1" cellspacing="1" class="tb_Info">--%>
                                        <%--                      <tr>
                        <td colspan="2">--%>
                                        <asp:RadioButton ID="rdoMLDCASEARDATA" Enabled="false" runat="server" Visible="True" style="display: none" />
                                        <%--應收帳款案件--%>
                                        <%--                        </td>
                      </tr>--%>
                                        <%--<tr>
                                    ...
                                    <div style="clear: both;">
                                        <table cellpadding="1" cellspacing="1" class="tb_Info">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="drpPAYTPE" DataTextField="MNAME1" DataValueField="MCODE" class="bg_F5F8BE" runat="server"  OnSelectedIndexChanged="drpPAYTPE_SelectedIndexChanged" AutoPostBack="true">
                                                    </asp:DropDownList>
                                                </td>
                                                <th>選定專案
                                                </th>
                        ...
                        <div id="fraTab33" class="div_content T_-120" style="display: none">
                            <asp:UpdatePanel ID="UpdatePanel4" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                                <contenttemplate>
                                    ...
                                    <asp:Button ID="btnMLDCASETARGETExample" runat="server" CssClass="btn_normal" Text="匯入範本下載" OnClick="btnMLDCASETARGETExample_Click" />
                                    <br />
                                    <span style="color: Red">[ 新增請按F8&nbsp;&nbsp;&nbsp;刪除請按F9 ]</span><br />
                                    <span style="color: Red">[ 若為兩方案件，當客戶(同供應商)無法提供近6個月內之採購證明時，設備狀況請選"原機融資"]</span>
                                </contenttemplate>
                                <triggers>
                                            ...
                                            <asp:Repeater ID="rptMLDCASETARGET" runat="server">
                                                <itemtemplate>
                                                    <tr onmouseover="MouseOver(event)" onmouseout="MouseOut(event)" onmousedown="MouseDown(event);markSelRow('rptMLDCASETARGET','<%# Container.ItemIndex  %>')">
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="drpTARGETTYPE" DataTextField="MNAME1" DataValueField="MCODE" class="bg_F5F8BE" runat="server">
                                                            </asp:DropDownList>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="drpTARGETSTATUS" DataTextField="MNAME1" DataValueField="MCODE" runat="server" onchange="drpTARGETSTATUS_change(this);">
                                                                <asp:ListItem>新機</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtTARGETMODELNO" onblur="CheckMLength(this,'50');" MaxLength="50" Text='<%# Eval("TARGETMODELNO")%>' runat="server" CssClass="txt_must"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <%--Modify 20131001 By SS Eric    Reason:在標的物頁籤中，標的物的GRID增加製造廠商，廠牌，單位，數量--%>
                                                        <td>
                                                            <asp:TextBox ID="txtMANUFACTURER" Text='<%# Eval("MANUFACTURER")%>' runat="server" Width="160px" CssClass="txt_must" MaxLength="50"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtTARGETBRAND" Text='<%# Eval("TARGETBRAND")%>' runat="server" CssClass="txt_table" MaxLength="50"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtTARGETUNIT" Text='<%# Eval("TARGETUNIT")%>' runat="server" CssClass="txt_must" MaxLength="50"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtTARGETCOUNT" onkeypress="OnlyNum(this);" Text='<%# Eval("TARGETCOUNT")%>' MaxLength="3" onblur="MoneyBlur(this);MoneyNull2(this);" runat="server" CssClass="txt_must"></asp:TextBox>
                                                        </td>
                                                        <td>
                            ...
                            <div class="div_table" style="overflow: scroll; height: 200px">
                                <asp:UpdatePanel ID="UpdatePanelMLDCASETARGETSTR" runat="server" UpdateMode="Conditional">
                                    <contenttemplate>
                                        <table id="tblMLDCASETARGETSTR" class="tb_Contact" style="width: 1200px;">
                                            <tr onclick="changeTag('rptMLDCASETARGET')">
                                                <th>項次
                                                </th>
                                                <th>存放地
                                                ...
                                                <itemtemplate>
                                                    <tr onmouseover="MouseOver(event)" onmouseout="MouseOut(event)" onmousedown="MouseDown(event);markSelRow('rptMLDCASEGUARANTEE','<%# Container.ItemIndex  %>')">
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:DropDownList ID="drpGUARANTEEBILL" OnSelectedIndexChanged="drpGUARANTEEBILL_SelectedIndexChanged" runat="server" Width="80%" AutoPostBack="true">
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="button" id="btnGRTRESIDENTZIP" class="btn_normal" onclick="PostCodeClick(this);" onfocus="ObjFocus(this);" style="width: 25px; padding: 2px;" value="&#8230;" runat="server" />
                                                ...
                                                <itemtemplate>
                                                    <tr onmouseover="MouseOver(event)" onmouseout="MouseOut(event)" onmousedown="MouseDown(event);markSelRow('rptMLDCASEMOVABLE','<%# Container.ItemIndex  %>')">
                                                        ...
                                                        <td>
                                                            ...
                                                            <%-- 20130913 Edit by Sean 動產設定所在地欄位可輸入50個中文字 --%>
                                                ...
                                                <itemtemplate>
                                                    <tr onmouseover="MouseOver(event)" onmouseout="MouseOut(event)" onmousedown="MouseDown(event);markSelRow('rptMLDCASEIMMOVABLE','<%# Container.ItemIndex  %>')">
                                                        ...
                                                        <td>
                                                            ...
                                                            <%-- 20130227 Edit by Sean 新增統編及ID判斷 --%>
                    ...
                    <div class="btn_div">
                        <%--20231130 ADD報價單列印--%>
                        <asp:Button ID="cmdPrintReportB" runat="server" Text="列印報價單" CssClass="btn_normal" OnClientClick="javascipt:return cmdPrintB_onClick(this);" Width="90" />
                        ...
                        <asp:Button ID="btnSubmit" Enabled="false" runat="server" Text="進件確認" CssClass="btn_normal" OnClick="btnSubmit_Click" />
                        <!--Modify 20120607 By SS Gordon. Reason: 新增案件撤件按鈕.-->
