...
public partial class FrmML7001 : PageBase
{
  protected void Page_Load(object sender, EventArgs e)
  {
    GetUsrAndFuncInfo();
    //===== for 測試Menu =====
    if (GSTR_PROGNM == "") GSTR_PROGNM = "撥款應付立帳轉檔作業";
    if (GSTR_A_PRGID == "") GSTR_A_PRGID = "ML7001";
    if (GSTR_U_PRGID == "") GSTR_U_PRGID = "ML7001";
    //========================             
    if (!IsPostBack)
    {
      //綁定公司別下拉
  ...
  private void TransData()
  {
    ...
    //案件主鍵
    LSTR_Data.Append("SP_ML7001_I01" + GSTR_ColDelimitChar);
