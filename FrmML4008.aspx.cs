...
public partial class FrmML4008 : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (GSTR_A_PRGID == "") GSTR_A_PRGID = "ML4008";
        if (GSTR_U_PRGID == "") GSTR_U_PRGID = "ML4008";
    ...
    private void drpCompIDBind()
    {
        ...
        try
        {
            ...
            aryParameter[1] = "'" + LSTR_SYSID + "','" + LSTR_DataID + "','T'";
...
//        strQueryCon += " AND A.INVNO IS NULL AND A.INVDATE IS NULL";
      }
      catch (Exception ex)
      {
        throw ex;
    ...
    private void rptDataBind()
    {
      ...
      try
      {
          ...
          if (!String.IsNullOrEmpty(this.drpCompID.SelectedValue.Trim()) && (this.drpCompID.SelectedValue.Trim() != ""))
          {
              LSTR_QueryCon += " AND  B1.COMPID = ''" + this.drpCompID.SelectedValue.Trim() + "''";
          }
          if (!String.IsNullOrEmpty(this.txtInvMonth.Text.Trim()) && (this.txtInvMonth.Text.Trim() != ""))
          {
              LSTR_QueryCon += " AND  B1.PREINVYYYYMM  < ''" + Itg.Community.Util.GetADYear(this.txtInvMonth.Text.Trim()) + "''";
          }
          aryParameter[1] = "'" + LSTR_QueryCon + "'";
        ...
        if (objReturnObj.ReturnSuccess)
        {
          ...
          this.txtInvRowCount.Text = objReturnObj.ReturnData.Rows.Count.ToString();
    ...
    private void getMLMPREINVOICEColInf(ref StringBuilder stbSaveFields, DataTable dtbPREINVOICE)
    {
        ...
        //押設息(總體彙開)
        stbSaveFields.Append("SP_ML4008_I04" + GSTR_ColDelimitChar);
        stbSaveFields.Append(this.drpCompID.SelectedValue + GSTR_TabDelimitChar);
        stbSaveFields.Append(this.drpMainType.SelectedValue + GSTR_TabDelimitChar);
        stbSaveFields.Append(Request.Form.GetValues("txtInvMonth")[0].ToString().Replace("/", "").Trim() + GSTR_TabDelimitChar);
        ...
        ////押設息(單體彙開)
        //stbSaveFields.Append("SP_ML4008_I05" + GSTR_ColDelimitChar);
        //stbSaveFields.Append(Request.Form.GetValues("txtInvMonth")[0].ToString().Replace("/", "").Trim() + GSTR_TabDelimitChar);
        //stbSaveFields.Append(this.drpMainType.SelectedValue + GSTR_TabDelimitChar);
        //stbSaveFields.Append("2" + GSTR_TabDelimitChar);
        //stbSaveFields.Append(this.drpCompID.SelectedValue + GSTR_TabDelimitChar);
        //stbSaveFields.Append(Request.Form.GetValues("txtInvMonth")[0].ToString().Replace("/", "").Trim() + "01" + GSTR_TabDelimitChar);
        //stbSaveFields.Append(GSTR_A_PRGID + GSTR_TabDelimitChar);//A_PRGID
        //stbSaveFields.Append(GSTR_A_USERID + GSTR_TabDelimitChar);//A_USERID 
        //stbSaveFields.Append(GSTR_U_PRGID + GSTR_TabDelimitChar);//U_PRGID
        //stbSaveFields.Append(GSTR_U_USERID + GSTR_TabDelimitChar);//U_USERID
        ...
        //{
        //    //租金-總體彙開
        //    stbSaveFields.Append("SP_ML4008_I02" + GSTR_ColDelimitChar);
        //    stbSaveFields.Append(Request.Form.GetValues("txtInvMonth")[0].ToString().Replace("/", "").Trim() + GSTR_TabDelimitChar);
        //    stbSaveFields.Append(this.drpMainType.SelectedValue + GSTR_TabDelimitChar);
        ...
        //    stbSaveFields.Append(GSTR_RowDelimitChar);
        //    //租金-單體彙開
        //    stbSaveFields.Append("SP_ML4008_I01" + GSTR_ColDelimitChar);
        //    stbSaveFields.Append(Request.Form.GetValues("txtInvMonth")[0].ToString().Replace("/", "").Trim() + GSTR_TabDelimitChar);
        //    stbSaveFields.Append(this.drpMainType.SelectedValue + GSTR_TabDelimitChar);
        //    stbSaveFields.Append("1" + GSTR_TabDelimitChar);
        //    stbSaveFields.Append(this.drpCompID.SelectedValue + GSTR_TabDelimitChar);
        ...
        //    stbSaveFields.Append(GSTR_RowDelimitChar);
        //    //租金-單體不彙開
        //    stbSaveFields.Append("SP_ML4008_I03" + GSTR_ColDelimitChar);
        //    stbSaveFields.Append(Request.Form.GetValues("txtInvMonth")[0].ToString().Replace("/", "").Trim() + GSTR_TabDelimitChar);
        //    stbSaveFields.Append(this.drpMainType.SelectedValue + GSTR_TabDelimitChar);
        //    stbSaveFields.Append("1" + GSTR_TabDelimitChar);
        //    stbSaveFields.Append(this.drpCompID.SelectedValue + GSTR_TabDelimitChar);
        ...
        //    stbSaveFields.Append(GSTR_RowDelimitChar);
        //}
        //else if (this.drpMainType.SelectedValue == "02")
        //{
        //    //租金-單體彙開
        //    stbSaveFields.Append("SP_ML4008_I01" + GSTR_ColDelimitChar);
        //    stbSaveFields.Append(Request.Form.GetValues("txtInvMonth")[0].ToString().Replace("/", "").Trim() + GSTR_TabDelimitChar);
        ...
        //    stbSaveFields.Append(GSTR_RowDelimitChar);
        //}
        //else if (this.drpMainType.SelectedValue == "03")
        //{
        //    //本體
        //    stbSaveFields.Append("SP_ML4008_I04" + GSTR_ColDelimitChar);
        //    stbSaveFields.Append(Request.Form.GetValues("txtInvMonth")[0].ToString().Replace("/", "").Trim() + GSTR_TabDelimitChar);
        //    stbSaveFields.Append(this.drpMainType.SelectedValue + GSTR_TabDelimitChar);
        //    stbSaveFields.Append("4" + GSTR_TabDelimitChar);
        //    stbSaveFields.Append(this.drpCompID.SelectedValue + GSTR_TabDelimitChar);
        //    stbSaveFields.Append(Request.Form.GetValues("txtInvMonth")[0].ToString().Replace("/", "").Trim() + "01" + GSTR_TabDelimitChar);
        //    stbSaveFields.Append(GSTR_A_PRGID + GSTR_TabDelimitChar);//A_PRGID
        //    stbSaveFields.Append(GSTR_A_USERID + GSTR_TabDelimitChar);//A_USERID 
        ...
        //    stbSaveFields.Append(Request.Form.GetValues("txtInvMonth")[0].ToString().Replace("/", "").Trim() + GSTR_TabDelimitChar);
        //    stbSaveFields.Append(this.drpMainType.SelectedValue + GSTR_TabDelimitChar);
        //    stbSaveFields.Append("5" + GSTR_TabDelimitChar);
        //    stbSaveFields.Append(this.drpCompID.SelectedValue + GSTR_TabDelimitChar);
        //    stbSaveFields.Append(Request.Form.GetValues("txtInvMonth")[0].ToString().Replace("/", "").Trim() + "01" + GSTR_TabDelimitChar);
        //    stbSaveFields.Append(GSTR_A_PRGID + GSTR_TabDelimitChar);//A_PRGID
        //    stbSaveFields.Append(GSTR_A_USERID + GSTR_TabDelimitChar);//A_USERID 
        ...
        //    stbSaveFields.Append(Request.Form.GetValues("txtInvMonth")[0].ToString().Replace("/", "").Trim() + GSTR_TabDelimitChar);
        //    stbSaveFields.Append(this.drpMainType.SelectedValue + GSTR_TabDelimitChar);
        //    stbSaveFields.Append("6" + GSTR_TabDelimitChar);
        //    stbSaveFields.Append(this.drpCompID.SelectedValue + GSTR_TabDelimitChar);
        //    stbSaveFields.Append(Request.Form.GetValues("txtInvMonth")[0].ToString().Replace("/", "").Trim() + "01" + GSTR_TabDelimitChar);
        //    stbSaveFields.Append(GSTR_A_PRGID + GSTR_TabDelimitChar);//A_PRGID
        //    stbSaveFields.Append(GSTR_A_USERID + GSTR_TabDelimitChar);//A_USERID 
        ...
        //    stbSaveFields.Append(GSTR_RowDelimitChar);
        //}
        //else if (this.drpMainType.SelectedValue == "04")
        //{
        //    //本體+分差
        //    stbSaveFields.Append("SP_ML4008_I04" + GSTR_ColDelimitChar);
        //    stbSaveFields.Append(Request.Form.GetValues("txtInvMonth")[0].ToString().Replace("/", "").Trim() + GSTR_TabDelimitChar);
        ...
        JObject json = new JObject(
            ...
            new JProperty("reportVar",
                ...
                new JObject(
                    ...
                    new JProperty("value", txtInvMonth.Text)
                ),
                new JObject(
