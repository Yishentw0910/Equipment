<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmML3011.aspx.cs" Inherits="FrmML3011" %>
      ...
      <table width="100%" cellpadding="1" cellspacing="1" class="tab_query">
        ...
        <tr>
          <td style="text-align: center;" colspan="4">
            <asp:Button ID="cmdPrintReport" runat="server" Text="列印核准書" CssClass="btn_normal"
              OnClientClick="javascipt:return cmdPrint_onClick(this);" Width="100" />
          </td>
        </tr>
      </table>
    </div>
