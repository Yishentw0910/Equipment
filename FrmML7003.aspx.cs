...
public partial class FrmML7003 : PageBase
{
  protected void Page_Load(object sender, EventArgs e)
  {
    GetUsrAndFuncInfo();
    //===== for 測試Menu =====
    if (GSTR_PROGNM == "") GSTR_PROGNM = "標的物轉固定資產轉檔作業";
    if (GSTR_A_PRGID == "") GSTR_A_PRGID = "ML7003";
    if (GSTR_U_PRGID == "") GSTR_U_PRGID = "ML7003";
    //========================             
    if (!IsPostBack)
    {
      //綁定公司別下拉
  ...
  private void TransData()
  {
    ...
    //案件主鍵
    LSTR_Data.Append("SP_ML7003_I01" + GSTR_ColDelimitChar);
